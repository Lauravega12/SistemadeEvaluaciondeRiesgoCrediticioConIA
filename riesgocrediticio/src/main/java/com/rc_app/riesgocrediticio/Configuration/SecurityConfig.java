...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .cors() // 👈 Activa el soporte para CORS
                .and()
                .csrf().disable()
    ...
    // ✅ Configuración CORS para permitir a React comunicarse con Spring Boot
    @Bean
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowCredentials(true); // Por si usas cookies (opcional aquí)
